...
export const metadata: Metadata = {
  ...
  description:
    "Terms and policies for The Jack Wharff Band official website, operated by Borchetta Entertainment Group, LLC and its affiliates.",
  alternates: { canonical: "https://thejackwharffband.com/legal" },
...
export default function LegalHubPage() {
  return (
    <section data-bg="primary" className="legal-typeset bg-background-primary px-5 pt-32 pb-20 md:pb-28 lg:px-12">
        ...
        <ul className="mt-10 flex flex-col gap-4">
          {POLICIES.map((p) => (
            <li key={p.href}>
              ...
              >
                <span className="text-[20px] font-bold text-text-accent md:text-[24px]">{p.title}</span>
